...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=20, n_batch=256):
	...
	for i in range(n_epochs):
		...
		for j in range(bat_per_epo):
			...
			#print("Shape of X:", X.shape)  # Should be (batch_size, 28, 28, 1)
...
dummy_X = np.random.rand(256, 28, 28, 1).astype('float32')
dummy_y = np.random.randint(0, 2, (256, 1))
d_loss = d_model.train_on_batch(dummy_X, dummy_y)
print("Discriminator dummy training loss:", d_loss)
